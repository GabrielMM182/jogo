(function () {
	...
	function valuesVariables () {
		...
		interval = 200;
	 	...
	 	//Status
	  	arrStatus = ["Start","Jogando","Pausado","Você venceu","Você perdeu"];
	...
	//ranking de pontuação score SALVAR
	let pontos =[lblScore , lblLevel];
	localStorage.setItem(lblScore,lblLevel, JSON.stringify(pontos));

	//ranking de pontuação score RECEBER
	let salvaa = localStorage.getItem(lblScore, lblLevel);
	nomes = JSON.parse(salvaa);
